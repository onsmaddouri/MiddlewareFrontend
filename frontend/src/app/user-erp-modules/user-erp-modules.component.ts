...
@Component({
  selector: 'app-user-erp-modules',
  templateUrl: './user-erp-modules.component.html',
  styleUrls: ['./user-erp-modules.component.css']
})
export class UserErpModulesComponent implements OnInit {
  modules: any[] = [];
  filteredModules: any[] = [];
